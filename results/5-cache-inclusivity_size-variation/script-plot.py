...
ax.set_title("IPC vs L1 size with different Inclusion Policies")
ax.set_xticks(x)
ax.set_xticklabels(x_labels)
ax.legend()
plt.savefig("L1-inc-size")
...
ax.set_title("IPC vs L2 size with different Inclusion Policies")
ax.set_xticks(x)
ax.set_xticklabels(x_labels)
ax.legend()
# plt.savefig()
plt.savefig("L2-inc-size")
...
ax.set_title("IPC vs L3 size with different Inclusion Policies")
ax.set_xticks(x)
ax.set_xticklabels(x_labels)
ax.legend()
plt.savefig("L3-inc-size")
plt.show()
